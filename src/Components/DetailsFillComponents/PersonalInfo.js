...
function PersonalInfo(props) {
  ...
  return (
    <div style={{ padding: "15px", textAlign: "left" }} className='personal'>
      <div>
        <div>
          ...
          <div className="col-lg-6 col-12 pt-5 px-4">
            <div className='row '>
              ...
              <div className='col-sm-10  col-12'>
                ...
                >
                  <option style={{ color: '#405D72' }}>Select State</option>
        ...
        <div className=" row font">
          <div className="col-lg-8 col-12 pt-5 px-4">
            <div className='row '>
              <div className='col-sm-2  col-12'>
        ...
        <div className=" row font">
          <div className="col-lg-12 col-12 pt-5 px-4">
            <div className='row '>
              ...
              <div className='col-lg-15 col-sm-16 col-12'>
